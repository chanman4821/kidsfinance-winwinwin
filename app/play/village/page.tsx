    ...
    <div className="relative min-h-screen pb-28 bg-transparent">
      ...
      <div className="max-w-md mx-auto px-3 pt-3 relative z-10">
        <div className="flex items-center gap-2 mb-3">
          <Link href="/" className="text-xs underline text-[#2b2640]/60 font-bold display">
            ← back
          </Link>
        ...
        <div className="flex items-end gap-2 mb-3">
          ...
          <div className="bg-white rounded-2xl px-3 py-2 self-center mt-1 shadow-[0_3px_0_0_#2b2640] border-[3px] border-[#2b2640] flex-1 relative">
      ...
      <div className="max-w-md mx-auto px-6 pt-12 pb-12 relative z-10">
        ...
        <div className="bg-white rounded-3xl p-5 border-[4px] border-white shadow-2xl space-y-4">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-full text-lg font-bold text-white bg-[#5aa9e6] border-[4px] border-white shadow-[0_6px_0_0_#3b80b0] active:translate-y-1 active:shadow-[0_2px_0_0_#3b80b0] disabled:opacity-50 display"
          >
            Move to Coinwood 🏠
          </button>
        </div>
          ...
          <div className="space-y-2">
            {undone.slice(0, 5).map((c) => (
              ...
              >
                ...
                <div className="bg-[#6ad48b] text-white px-3 py-1.5 rounded-full display text-xs font-bold">Done!</div>
              </button>
            ))}
          </div>
        )}
  ...
  return (
    <div className="space-y-3">
      <div className="bg-white/90 backdrop-blur rounded-2xl p-4 border-[3px] border-white shadow-lg">
        ...
        {/* Pricing */}
        <div className="bg-[#fff3b0]/60 rounded-xl p-3 mb-3">
      ...
      <div className="bg-white/90 backdrop-blur rounded-2xl p-3 border-[3px] border-white shadow-lg">
              ...
              <button
                ...
                className={`p-2 rounded-xl border-2 ${
                  active
                    ...
                    : "bg-white border-[#2b2640]/10 hover:border-[#5aa9e6]"
        ...
        <button
          ...
          className="w-full bg-[#5aa9e6] text-white py-2 rounded-xl display font-bold text-xs disabled:opacity-40 active:scale-95"
        >
...
function ShopsTab({
  ...
  return (
    <div className="space-y-3">
      ...
      {owned.length > 0 && (
        <div className="bg-[#d4f4dd] rounded-2xl p-3 border-[3px] border-white shadow-lg">
          ...
          <button
            onClick={onCollect}
            className="mt-2 w-full bg-[#4fa86c] text-white py-3 rounded-full display font-bold text-base active:scale-95 shadow-[0_4px_0_0_#3a7e51]"
          >
      ...
      <div className="space-y-2">
        {SHOPS.map((s) => {
          ...
          return (
            <div
              key={s.id}
              className={`bg-white/90 backdrop-blur rounded-2xl p-3 border-[3px] border-white shadow-lg flex items-center gap-3 ${
            ...
            >
              ...
              {isOwned ? (
                ...
                <button
                  ...
                  className="bg-[#5aa9e6] text-white px-3 py-2 rounded-full display font-bold text-xs disabled:opacity-40 shrink-0"
                >
                  🪙 {s.cost}
                </button>
              )}
...
function GoalsTab({ state, setState }: { state: VillageState; setState: (s: VillageState) => void }) {
  return (
    <div className="space-y-3">
      <div className="bg-[#fff3b0]/80 backdrop-blur rounded-2xl p-3 border-[3px] border-white shadow text-xs">
        💡 <strong>Set a goal you&apos;re saving for.</strong> Every coin in your Save jar gets you closer!
      </div>

      {state.goal && (
        <div className="bg-[#d4f4dd] rounded-2xl p-4 border-[3px] border-white shadow-lg">
          ...
          <div className="flex items-center gap-3 mt-1">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 h-3 bg-white/60 rounded-full overflow-hidden border-2 border-white">
                <div
      ...
      <div className="grid grid-cols-2 gap-3">
        {GOAL_PRESETS.map((g) => (
          <button
            ...
            className="bg-white/90 backdrop-blur rounded-2xl p-3 border-[3px] border-white shadow active:scale-95 transition-transform text-left"
          >
...
function PetTab({ state }: { state: VillageState }) {
  ...
  return (
    <div className="space-y-3">
      <div className="bg-white/90 backdrop-blur rounded-2xl p-6 border-[3px] border-white shadow-lg text-center">
      ...
      <div className="bg-[#fff3b0]/60 rounded-2xl p-3 border-2 border-white text-xs text-[#2b2640]/80">
...
function Stat({ icon, label, value, bg }: { icon: string; label: string; value: number; bg: string }) {
  return (
    <div className={`${bg} rounded-xl p-2 text-center border-2 border-white`}>
